...
usage: compare_masks.py [-h] -g GROUND_TRUTH_DIR -p PREDICTION_DIR -o PN_OUTPUT_DIR
...
optional arguments:
  ...
  -o PN_OUTPUT_DIR, --pn-output-dir FP_OUTPUT_DIR

$ python3 scripts/compare_mask.py -g data/extracted_masks -p data/recovered_masks/table_detector_1 -o data/pn_masks/table_detector_1
```
